...
| **系统管理员 / 教师 (Admin)** | 知识库文档上传/切片预览/删除、全局 System Prompt 模板版本审核与激活、查看 Bad Case 反馈日志、配置模型路由 gateway 参数与离线微调任务。 | 知识库管理台、系统设置控制台、提示词演化控制台 |
...
flowchart LR
    ...
    Phase3["阶段三 (远期目标)<br>· 交互式代码 Trace 可视化<br>· 边缘端 WebGPU 本地端侧推理<br>· 跨学科算法知识图谱自动生成"]

    Phase1 --> Phase2 --> Phase3

    class Phase1,Phase2,Phase3 blackWhite;
```
